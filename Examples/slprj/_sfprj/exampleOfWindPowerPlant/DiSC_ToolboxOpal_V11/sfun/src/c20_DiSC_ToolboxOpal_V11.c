...
#include "c20_DiSC_ToolboxOpal_V11.h"
...
static const char * c20_debug_family_names[16] = { "param", "varNew", "nargin",
  "nargout", "wind", "vMeas", "dP", "dPlim", "qRef", "qMode", "vRef", "time",
  "p", "q", "pAva", "var" };

static const char * c20_b_debug_family_names[6] = { "nargin", "nargout", "var",
  "w", "wOut", "varNew" };

static const char * c20_c_debug_family_names[11] = { "pW", "nargin", "nargout",
  "param", "var", "w", "dP", "dPlim", "p", "pAva", "varNew" };

static const char * c20_d_debug_family_names[9] = { "vMax", "vMin", "k",
  "nargin", "nargout", "param", "v", "vRef", "qRef" };

static const char * c20_e_debug_family_names[7] = { "qFun", "nargin", "nargout",
  "param", "v", "vRef", "qRef" };

static const char * c20_f_debug_family_names[10] = { "qMax", "nargin", "nargout",
  "param", "var", "p", "v", "qRef", "vRef", "q" };

static const char * c20_g_debug_family_names[7] = { "nargin", "nargout", "param",
  "var", "u", "p", "varNew" };

static const char * c20_h_debug_family_names[14] = { "nargin", "nargout", "obj",
  "var", "wt", "v", "dP", "dPlim", "qRef", "vRef", "p", "q", "pAva", "varNew" };

/* Function Declarations */
static void initialize_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void initialize_params_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void enable_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void disable_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void c20_update_debugger_state_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void set_sim_state_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance, const mxArray
   *c20_st);
static void finalize_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void sf_gateway_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void mdl_start_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void c20_chartstep_c20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void initSimStructsc20_DiSC_ToolboxOpal_V11
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void c20_sampleWT(SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
  c20_sXgiQ0K2zU5uHJ7gdbD52xC *c20_obj, c20_sH1Kify8ZxEOY46vFTteWED *c20_b_var,
  real_T c20_wt, real_T c20_v, real_T c20_b_dP, real_T c20_b_dPlim, real_T
  c20_b_qRef, real_T c20_b_vRef, real_T *c20_b_p, real_T *c20_b_q, real_T
  *c20_b_pAva, c20_sH1Kify8ZxEOY46vFTteWED *c20_varNew);
static void c20_pCtrlWT(SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
  c20_sXgiQ0K2zU5uHJ7gdbD52xC *c20_param, c20_sH1Kify8ZxEOY46vFTteWED *c20_b_var,
  real_T c20_w, real_T c20_b_dP, real_T c20_b_dPlim, real_T *c20_b_p, real_T
  *c20_b_pAva, c20_sH1Kify8ZxEOY46vFTteWED *c20_varNew);
...
static const mxArray *c20_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_b_var, const char_T *c20_identifier,
  c20_sH1Kify8ZxEOY46vFTteWED *c20_y);
static void c20_b_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId,
  c20_sH1Kify8ZxEOY46vFTteWED *c20_y);
static real_T c20_c_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_d_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId,
  real_T c20_y[10]);
...
static const mxArray *c20_b_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static real_T c20_e_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_b_pAva, const char_T *c20_identifier);
...
static const mxArray *c20_c_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_f_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId,
  c20_sH1Kify8ZxEOY46vFTteWED *c20_y);
...
static const mxArray *c20_d_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static void c20_g_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId,
  c20_sXgiQ0K2zU5uHJ7gdbD52xC *c20_y);
...
static real_T c20_mpower(SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
  real_T c20_a);
static void c20_eml_scalar_eg(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static real_T c20_sum(SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
                      real_T c20_x[10]);
static void c20_eml_error(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static real_T c20_b_mpower(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, real_T c20_a);
static void c20_b_eml_error(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static const mxArray *c20_f_sf_marshallOut(void *chartInstanceVoid, void
  *c20_inData);
static int32_T c20_h_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void c20_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData);
static uint8_T c20_i_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_b_is_active_c20_DiSC_ToolboxOpal_V11, const
  char_T *c20_identifier);
static uint8_T c20_j_emlrt_marshallIn(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId);
static void init_dsm_address_info(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
  ...
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c20_var_not_empty = false;
  chartInstance->c20_is_active_c20_DiSC_ToolboxOpal_V11 = 0U;
}
  ...
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  c20_c_hoistedGlobal = *chartInstance->c20_q;
  ...
  c20_e_y = NULL;
  if (!chartInstance->c20_var_not_empty) {
    sf_mex_assign(&c20_e_y, sf_mex_create("y", NULL, 0, 0U, 1U, 0U, 2, 0, 0),
                  false);
  } else {
    sf_mex_assign(&c20_e_y, sf_mex_createstruct("structure", 2, 1, 1), false);
    c20_d_u = chartInstance->c20_var.p_c;
    c20_f_y = NULL;
    sf_mex_assign(&c20_f_y, sf_mex_create("y", &c20_d_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_f_y, "p_c", "p_c", 0);
    c20_e_u = chartInstance->c20_var.q_c;
    c20_g_y = NULL;
    sf_mex_assign(&c20_g_y, sf_mex_create("y", &c20_e_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_g_y, "q_c", "q_c", 0);
    c20_f_u = chartInstance->c20_var.pAva_c;
    c20_h_y = NULL;
    sf_mex_assign(&c20_h_y, sf_mex_create("y", &c20_f_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_h_y, "pAva_c", "pAva_c", 0);
    c20_g_u = chartInstance->c20_var.t_c;
    c20_i_y = NULL;
    sf_mex_assign(&c20_i_y, sf_mex_create("y", &c20_g_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_i_y, "t_c", "t_c", 0);
    c20_h_u = chartInstance->c20_var.pOld;
    c20_j_y = NULL;
    sf_mex_assign(&c20_j_y, sf_mex_create("y", &c20_h_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_j_y, "pOld", "pOld", 0);
    c20_i_u = chartInstance->c20_var.avgFilterTime;
    c20_k_y = NULL;
    sf_mex_assign(&c20_k_y, sf_mex_create("y", &c20_i_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_k_y, "avgFilterTime", "avgFilterTime", 0);
    for (c20_i0 = 0; c20_i0 < 10; c20_i0++) {
      c20_j_u[c20_i0] = chartInstance->c20_var.avgFilterBuf[c20_i0];
    }

    c20_l_y = NULL;
    sf_mex_assign(&c20_l_y, sf_mex_create("y", c20_j_u, 0, 0U, 1U, 0U, 1, 10),
                  false);
    sf_mex_addfield(c20_e_y, c20_l_y, "avgFilterBuf", "avgFilterBuf", 0);
    c20_k_u = chartInstance->c20_var.Qmode;
    c20_m_y = NULL;
    sf_mex_assign(&c20_m_y, sf_mex_create("y", &c20_k_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_m_y, "Qmode", "Qmode", 0);
    c20_l_u = chartInstance->c20_var.kWT;
    c20_n_y = NULL;
    sf_mex_assign(&c20_n_y, sf_mex_create("y", &c20_l_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_e_y, c20_n_y, "kWT", "kWT", 0);
  }

  sf_mex_setcell(c20_y, 3, c20_e_y);
  c20_d_hoistedGlobal = chartInstance->c20_is_active_c20_DiSC_ToolboxOpal_V11;
  c20_m_u = c20_d_hoistedGlobal;
  c20_o_y = NULL;
  sf_mex_assign(&c20_o_y, sf_mex_create("y", &c20_m_u, 3, 0U, 0U, 0U, 0), false);
  sf_mex_setcell(c20_y, 4, c20_o_y);
...
{
  const mxArray *c20_u;
  c20_sH1Kify8ZxEOY46vFTteWED c20_r0;
  chartInstance->c20_doneDoubleBufferReInit = true;
  c20_u = sf_mex_dup(c20_st);
  *chartInstance->c20_p = c20_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c20_u, 0)), "p");
  *chartInstance->c20_pAva = c20_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c20_u, 1)), "pAva");
  *chartInstance->c20_q = c20_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell(c20_u, 2)), "q");
  c20_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 3)),
                       "var", &c20_r0);
  chartInstance->c20_var = c20_r0;
  chartInstance->c20_is_active_c20_DiSC_ToolboxOpal_V11 = c20_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c20_u, 4)),
     "is_active_c20_DiSC_ToolboxOpal_V11");
  sf_mex_destroy(&c20_u);
  c20_update_debugger_state_c20_DiSC_ToolboxOpal_V11(chartInstance);
  ...
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c20_sfEvent);
  chartInstance->c20_sfEvent = CALL_EVENT;
  c20_chartstep_c20_DiSC_ToolboxOpal_V11(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_DiSC_ToolboxOpal_V11MachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_p, 0U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_wind, 1U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_vMeas, 2U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_dP, 3U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_dPlim, 4U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_qRef, 5U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_qMode, 6U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_vRef, 7U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_time, 8U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_q, 9U);
  _SFD_DATA_RANGE_CHECK(*chartInstance->c20_pAva, 10U);
}
  ...
  (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  real_T c20_b_vRef;
  real_T c20_b_time;
  uint32_T c20_debug_family_var_map[16];
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_param;
  c20_sH1Kify8ZxEOY46vFTteWED c20_varNew;
  ...
  real_T c20_c_y;
  real_T c20_d_y;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_b_param;
  c20_sH1Kify8ZxEOY46vFTteWED c20_r1;
  c20_sH1Kify8ZxEOY46vFTteWED c20_b_varNew;
  real_T c20_c_pAva;
  real_T c20_c_q;
  real_T c20_c_p;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_c_param;
  c20_sH1Kify8ZxEOY46vFTteWED c20_r2;
  real_T c20_d_pAva;
  real_T c20_d_q;
  real_T c20_d_p;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c20_sfEvent);
  c20_hoistedGlobal = *chartInstance->c20_wind;
  c20_b_hoistedGlobal = *chartInstance->c20_vMeas;
  c20_c_hoistedGlobal = *chartInstance->c20_dP;
  c20_d_hoistedGlobal = *chartInstance->c20_dPlim;
  c20_e_hoistedGlobal = *chartInstance->c20_qRef;
  c20_f_hoistedGlobal = *chartInstance->c20_qMode;
  c20_g_hoistedGlobal = *chartInstance->c20_vRef;
  c20_h_hoistedGlobal = *chartInstance->c20_time;
  c20_b_wind = c20_hoistedGlobal;
  c20_b_vMeas = c20_b_hoistedGlobal;
  c20_b_dP = c20_c_hoistedGlobal;
  c20_b_dPlim = c20_d_hoistedGlobal;
  c20_b_qRef = c20_e_hoistedGlobal;
  c20_b_qMode = c20_f_hoistedGlobal;
  c20_b_vRef = c20_g_hoistedGlobal;
  c20_b_time = c20_h_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 16U, 16U, c20_debug_family_names,
    c20_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_param, 0U, c20_d_sf_marshallOut,
    c20_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_varNew, 1U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_nargout, 3U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_wind, 4U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_vMeas, 5U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_dP, 6U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_dPlim, 7U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_qRef, 8U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_qMode, 9U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_vRef, 10U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c20_b_time, 11U, c20_b_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_p, 12U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_q, 13U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_pAva, 14U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&chartInstance->c20_var, 15U,
    c20_sf_marshallOut, c20_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 22);
  c20_param.vBase = 20000.0;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 23);
  c20_param.pRated = 100000.0;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 24);
  c20_param.sMax = 100000.0;
  ...
  c20_param.wRated = 12.0;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 28);
  c20_param.rfTau = 20.0;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 29);
  c20_param.PF = 1.0;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 30);
  c20_param.Ts = 60.0;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 33);
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 34);
  if (CV_EML_IF(0, 1, 0, !chartInstance->c20_var_not_empty)) {
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 35);
    chartInstance->c20_var.p_c = 0.0;
    chartInstance->c20_var_not_empty = true;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 36);
    chartInstance->c20_var.q_c = 0.0;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 37);
    chartInstance->c20_var.pAva_c = 0.0;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 38);
    chartInstance->c20_var.t_c = 0.0;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 39);
    chartInstance->c20_var.pOld = 0.0;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 41);
    chartInstance->c20_var.avgFilterTime = 600.0;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 42);
    for (c20_i1 = 0; c20_i1 < 10; c20_i1++) {
      chartInstance->c20_var.avgFilterBuf[c20_i1] = 0.0;
    }

    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 43);
    chartInstance->c20_var.Qmode = 0.0;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 44);
    chartInstance->c20_var.kWT = 1736.1111111111111;
  }

  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 48);
  c20_A = c20_param.pRated;
  c20_B = c20_mpower(chartInstance, c20_param.wRated);
  c20_x = c20_A;
  c20_y = c20_B;
  c20_b_x = c20_x;
  c20_b_y = c20_y;
  c20_c_x = c20_b_x;
  c20_c_y = c20_b_y;
  c20_d_y = c20_c_x / c20_c_y;
  chartInstance->c20_var.kWT = c20_d_y;
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 52);
  if (CV_EML_IF(0, 1, 1, CV_RELATIONAL_EVAL(4U, 0U, 0, c20_param.Ts, 0.0, -1, 4U,
        c20_param.Ts > 0.0))) {
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 53);
    if (CV_EML_IF(0, 1, 2, CV_RELATIONAL_EVAL(4U, 0U, 1, c20_b_time,
          chartInstance->c20_var.t_c + c20_param.Ts, -1, 4U, c20_b_time >
          chartInstance->c20_var.t_c + c20_param.Ts))) {
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 54);
      c20_b_param = c20_param;
      c20_r1 = chartInstance->c20_var;
      c20_sampleWT(chartInstance, &c20_b_param, &c20_r1, c20_b_wind, c20_b_vMeas,
                   c20_b_dP, c20_b_dPlim, c20_b_qRef, c20_b_vRef, &c20_c_p,
                   &c20_c_q, &c20_c_pAva, &c20_b_varNew);
      c20_b_p = c20_c_p;
      c20_b_q = c20_c_q;
      c20_b_pAva = c20_c_pAva;
      c20_varNew = c20_b_varNew;
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 55);
      c20_varNew.p_c = c20_b_p;
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 56);
      c20_varNew.q_c = c20_b_q;
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 57);
      c20_varNew.pAva_c = c20_b_pAva;
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 58);
      c20_varNew.t_c = c20_b_time;
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 59);
      c20_varNew.Qmode = c20_b_qMode;
      _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 60);
      chartInstance->c20_var = c20_varNew;
    }

    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 62);
    c20_b_p = chartInstance->c20_var.p_c;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 63);
    c20_b_q = chartInstance->c20_var.q_c;
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 64);
    c20_b_pAva = chartInstance->c20_var.pAva_c;
  } else {
    _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, 66);
    c20_c_param = c20_param;
    c20_r2 = chartInstance->c20_var;
    c20_sampleWT(chartInstance, &c20_c_param, &c20_r2, c20_b_wind, c20_b_vMeas,
                 c20_b_dP, c20_b_dPlim, c20_b_qRef, c20_b_vRef, &c20_d_p,
                 &c20_d_q, &c20_d_pAva, &c20_b_varNew);
    c20_b_p = c20_d_p;
    c20_b_q = c20_d_q;
    c20_b_pAva = c20_d_pAva;
    c20_varNew = c20_b_varNew;
  ...
  _SFD_EML_CALL(0U, chartInstance->c20_sfEvent, -67);
  _SFD_SYMBOL_SCOPE_POP();
  *chartInstance->c20_p = c20_b_p;
  *chartInstance->c20_q = c20_b_q;
  *chartInstance->c20_pAva = c20_b_pAva;
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 2U, chartInstance->c20_sfEvent);
}
  ...
  *c20_b_pAva, c20_sH1Kify8ZxEOY46vFTteWED *c20_varNew)
{
  ...
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_b_obj;
  c20_sH1Kify8ZxEOY46vFTteWED c20_c_var;
  c20_sH1Kify8ZxEOY46vFTteWED c20_b_varNew;
  real_T c20_c_pAva;
  real_T c20_c_p;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_param;
  c20_sH1Kify8ZxEOY46vFTteWED c20_d_var;
  real_T c20_d_p;
  real_T c20_b_v;
  real_T c20_c_qRef;
  real_T c20_c_vRef;
  uint32_T c20_b_debug_family_var_map[10];
  real_T c20_qMax;
  real_T c20_b_nargin = 6.0;
  ...
  real_T c20_c_v;
  real_T c20_d_vRef;
  uint32_T c20_c_debug_family_var_map[7];
  real_T c20_c_nargin = 5.0;
  real_T c20_c_nargout = 1.0;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_c_param;
  real_T c20_d_v;
  real_T c20_e_vRef;
  uint32_T c20_d_debug_family_var_map[9];
  real_T c20_vMax;
  real_T c20_vMin;
  real_T c20_k;
  real_T c20_d_nargin = 4.0;
  ...
  real_T c20_c_y;
  int32_T c20_i2;
  static char_T c20_varargin_1[40] = { 'I', 'n', 'v', 'a', 'l', 'i', 'd', ' ',
  ...
  real_T c20_i_x;
  real_T c20_j_x;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_d_param;
  c20_sH1Kify8ZxEOY46vFTteWED c20_e_var;
  real_T c20_b_u;
  real_T c20_e_nargin = 3.0;
  real_T c20_e_nargout = 2.0;
  real_T c20_e_p;
  c20_sH1Kify8ZxEOY46vFTteWED c20_c_varNew;
  real_T c20_A;
  real_T c20_b_B;
  real_T c20_k_x;
  real_T c20_e_y;
  ...
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 14U, 14U, c20_h_debug_family_names,
    c20_debug_family_var_map);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_nargout, 1U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_obj, 2U, c20_d_sf_marshallOut,
    c20_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_var, 3U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_wt, 4U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_v, 5U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_dP, 6U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_dPlim, 7U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_qRef, 8U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_vRef, 9U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_p, 10U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_q, 11U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_pAva, 12U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_varNew, 13U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  CV_SCRIPT_FCN(0, 0);
  _SFD_SCRIPT_CALL(0U, chartInstance->c20_sfEvent, 21);
  c20_b_obj = *c20_obj;
  c20_c_var = *c20_b_var;
  c20_pCtrlWT(chartInstance, &c20_b_obj, &c20_c_var, c20_wt, c20_b_dP,
              c20_b_dPlim, &c20_c_p, &c20_c_pAva, &c20_b_varNew);
  *c20_b_p = c20_c_p;
  *c20_b_pAva = c20_c_pAva;
  *c20_varNew = c20_b_varNew;
  _SFD_SCRIPT_CALL(0U, chartInstance->c20_sfEvent, 22);
  *c20_b_var = *c20_varNew;
  _SFD_SCRIPT_CALL(0U, chartInstance->c20_sfEvent, 25);
  c20_param = *c20_obj;
  c20_d_var = *c20_b_var;
  c20_d_p = *c20_b_p;
  c20_b_v = c20_v;
  c20_c_qRef = c20_b_qRef;
  c20_c_vRef = c20_b_vRef;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 10U, 10U, c20_f_debug_family_names,
    c20_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_qMax, 0U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargin, 1U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargout, 2U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_param, 3U, c20_d_sf_marshallOut,
    c20_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_var, 4U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_p, 5U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_v, 6U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_qRef, 7U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_vRef, 8U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_q, 9U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  CV_SCRIPT_FCN(3, 0);
  _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 4);
  if (CV_SCRIPT_IF(3, 0, CV_RELATIONAL_EVAL(14U, 3U, 0, c20_d_var.Qmode, 0.0, -1,
        0U, c20_d_var.Qmode == 0.0))) {
    _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 5);
    c20_x = c20_param.PF;
    c20_b_x = c20_x;
    guard1 = false;
    if (c20_b_x < -1.0) {
    ...
    c20_b_x = muDoubleScalarAcos(c20_b_x);
    c20_c_x = c20_b_x;
    c20_d_x = c20_c_x;
    c20_d_x = muDoubleScalarTan(c20_d_x);
    c20_c_qRef = c20_d_p * c20_d_x;
  } else {
    _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 6);
    if (CV_SCRIPT_IF(3, 1, CV_RELATIONAL_EVAL(14U, 3U, 1, c20_d_var.Qmode, 1.0,
          -1, 0U, c20_d_var.Qmode == 1.0))) {
      _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 7);
    } else {
      _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 8);
      if (CV_SCRIPT_IF(3, 2, CV_RELATIONAL_EVAL(14U, 3U, 2, c20_d_var.Qmode, 2.0,
            -1, 0U, c20_d_var.Qmode == 2.0))) {
        _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 9);
        c20_b_param = c20_param;
        c20_c_v = c20_b_v;
        c20_d_vRef = c20_c_vRef;
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c20_e_debug_family_names,
          c20_c_debug_family_var_map);
        _SFD_SYMBOL_SCOPE_ADD_EML(NULL, 0U, c20_e_sf_marshallOut);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_nargin, 1U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_nargout, 2U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_param, 3U,
          c20_d_sf_marshallOut, c20_d_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_v, 4U, c20_b_sf_marshallOut,
          c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_vRef, 5U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_qRef, 6U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        CV_SCRIPT_FCN(4, 0);
        _SFD_SCRIPT_CALL(4U, chartInstance->c20_sfEvent, 4);
        CV_SCRIPT_SWITCH(4, 0, 0);
        _SFD_SCRIPT_CALL(4U, chartInstance->c20_sfEvent, 10);
        c20_c_param = c20_b_param;
        c20_d_v = c20_c_v;
        c20_e_vRef = c20_d_vRef;
        _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c20_d_debug_family_names,
          c20_d_debug_family_var_map);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_vMax, 0U, c20_b_sf_marshallOut,
          c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_vMin, 1U, c20_b_sf_marshallOut,
          c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_k, 2U, c20_b_sf_marshallOut,
          c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_nargin, 3U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_nargout, 4U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_param, 5U,
          c20_d_sf_marshallOut, c20_d_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_v, 6U, c20_b_sf_marshallOut,
          c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_e_vRef, 7U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_qRef, 8U,
          c20_b_sf_marshallOut, c20_b_sf_marshallIn);
        CV_SCRIPT_FCN(5, 0);
        _SFD_SCRIPT_CALL(5U, chartInstance->c20_sfEvent, 11);
        c20_vMax = c20_c_param.vBase * 1.1;
        _SFD_SCRIPT_CALL(5U, chartInstance->c20_sfEvent, 12);
        c20_vMin = c20_c_param.vBase * 0.9;
        _SFD_SCRIPT_CALL(5U, chartInstance->c20_sfEvent, 13);
        c20_B = c20_vMax - c20_vMin;
        c20_y = c20_B;
        c20_b_y = c20_y;
        c20_c_y = c20_b_y;
        c20_k = -2.0 / c20_c_y;
        _SFD_SCRIPT_CALL(5U, chartInstance->c20_sfEvent, 14);
        c20_c_qRef = c20_c_param.sMax * c20_k * (c20_d_v - c20_e_vRef);
        _SFD_SCRIPT_CALL(5U, chartInstance->c20_sfEvent, -14);
        _SFD_SYMBOL_SCOPE_POP();
        _SFD_SCRIPT_CALL(4U, chartInstance->c20_sfEvent, -10);
        _SFD_SYMBOL_SCOPE_POP();
      } else {
        _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 11);
        for (c20_i2 = 0; c20_i2 < 40; c20_i2++) {
          c20_u[c20_i2] = c20_varargin_1[c20_i2];
        }

        c20_d_y = NULL;
        sf_mex_assign(&c20_d_y, sf_mex_create("y", c20_u, 10, 0U, 1U, 0U, 2, 1,
          40), false);
  ...
  _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 14);
  c20_e_x = c20_b_mpower(chartInstance, c20_param.sMax) - c20_b_mpower
    (chartInstance, c20_d_p);
  c20_qMax = c20_e_x;
  if (c20_qMax < 0.0) {
  ...
  c20_f_x = c20_qMax;
  c20_qMax = c20_f_x;
  c20_qMax = muDoubleScalarSqrt(c20_qMax);
  _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 15);
  c20_g_x = c20_c_qRef;
  c20_h_x = c20_g_x;
  c20_d0 = muDoubleScalarAbs(c20_h_x);
  if (CV_SCRIPT_IF(3, 3, CV_RELATIONAL_EVAL(14U, 3U, 3, c20_d0, c20_qMax, -1, 4U,
        c20_d0 > c20_qMax))) {
    _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 16);
    c20_i_x = c20_c_qRef;
    c20_j_x = c20_i_x;
    c20_j_x = muDoubleScalarSign(c20_j_x);
    *c20_b_q = c20_j_x * c20_qMax;
  } else {
    _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, 18);
    *c20_b_q = c20_c_qRef;
  }

  _SFD_SCRIPT_CALL(3U, chartInstance->c20_sfEvent, -18);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_SCRIPT_CALL(0U, chartInstance->c20_sfEvent, 27);
  c20_d_param = *c20_obj;
  c20_e_var = *c20_b_var;
  c20_b_u = *c20_b_p;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 7U, 7U, c20_g_debug_family_names,
    c20_c_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_e_nargin, 0U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_e_nargout, 1U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_d_param, 2U, c20_d_sf_marshallOut,
    c20_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_e_var, 3U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_u, 4U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_e_p, 5U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_varNew, 6U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  CV_SCRIPT_FCN(6, 0);
  _SFD_SCRIPT_CALL(6U, chartInstance->c20_sfEvent, 3);
  c20_A = c20_d_param.Ts;
  c20_b_B = c20_d_param.rfTau + c20_d_param.Ts;
  c20_k_x = c20_A;
  c20_e_y = c20_b_B;
  c20_l_x = c20_k_x;
  c20_f_y = c20_e_y;
  c20_m_x = c20_l_x;
  c20_g_y = c20_f_y;
  c20_h_y = c20_m_x / c20_g_y;
  c20_b_A = c20_d_param.rfTau;
  c20_c_B = c20_d_param.rfTau + c20_d_param.Ts;
  c20_n_x = c20_b_A;
  c20_i_y = c20_c_B;
  c20_o_x = c20_n_x;
  c20_j_y = c20_i_y;
  c20_p_x = c20_o_x;
  c20_k_y = c20_j_y;
  c20_l_y = c20_p_x / c20_k_y;
  c20_e_p = c20_b_u * c20_h_y + c20_e_var.pOld * c20_l_y;
  _SFD_SCRIPT_CALL(6U, chartInstance->c20_sfEvent, 4);
  c20_e_var.pOld = c20_e_p;
  _SFD_SCRIPT_CALL(6U, chartInstance->c20_sfEvent, 5);
  c20_c_varNew = c20_e_var;
  _SFD_SCRIPT_CALL(6U, chartInstance->c20_sfEvent, -5);
  _SFD_SYMBOL_SCOPE_POP();
  *c20_b_p = c20_e_p;
  *c20_varNew = c20_c_varNew;
  _SFD_SCRIPT_CALL(0U, chartInstance->c20_sfEvent, 28);
  *c20_b_var = *c20_varNew;
  _SFD_SCRIPT_CALL(0U, chartInstance->c20_sfEvent, -28);
  _SFD_SYMBOL_SCOPE_POP();
}
  ...
  *c20_b_pAva, c20_sH1Kify8ZxEOY46vFTteWED *c20_varNew)
{
  ...
  c20_sH1Kify8ZxEOY46vFTteWED c20_c_var;
  real_T c20_b_w;
  uint32_T c20_b_debug_family_var_map[6];
  real_T c20_b_nargin = 3.0;
  real_T c20_b_nargout = 2.0;
  real_T c20_c_w;
  c20_sH1Kify8ZxEOY46vFTteWED c20_b_varNew;
  int32_T c20_i3;
  real_T c20_d_var[9];
  ...
  real_T c20_b_xk;
  real_T c20_i_x;
  real_T c20_e_varargin_2;
  real_T c20_c_varargin_3;
  real_T c20_g_y;
  real_T c20_h_y;
  real_T c20_c_yk;
  real_T c20_i_y;
  boolean_T guard1 = false;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 11U, 11U, c20_c_debug_family_names,
    c20_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_pW, 0U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_param, 3U, c20_d_sf_marshallOut,
    c20_d_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_var, 4U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_w, 5U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_dP, 6U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_dPlim, 7U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_p, 8U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_b_pAva, 9U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c20_varNew, 10U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  CV_SCRIPT_FCN(1, 0);
  _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 4);
  c20_pW = c20_b_var->kWT * c20_param->PF * c20_mpower(chartInstance, c20_w);
  _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 6);
  if (CV_SCRIPT_IF(1, 0, CV_RELATIONAL_EVAL(14U, 1U, 0, c20_pW,
        c20_param->pRated, -1, 5U, c20_pW >= c20_param->pRated))) {
    _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 7);
    *c20_b_pAva = c20_param->pRated;
  } else {
    _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 8);
    if (CV_SCRIPT_IF(1, 1, CV_RELATIONAL_EVAL(14U, 1U, 1, c20_pW, 0.0, -1, 3U,
          c20_pW <= 0.0))) {
  ...
  _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 14);
  c20_varargin_1 = c20_b_dP;
  c20_varargin_2 = c20_b_dPlim;
  c20_b_varargin_2 = c20_varargin_1;
  c20_varargin_3 = c20_varargin_2;
  c20_x = c20_b_varargin_2;
  c20_y = c20_varargin_3;
  c20_b_x = c20_x;
  c20_b_y = c20_y;
  ...
  c20_c_y = c20_yk;
  c20_eml_scalar_eg(chartInstance);
  c20_b_dP = muDoubleScalarMin(c20_c_x, c20_c_y);
  _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 17);
  c20_c_var = *c20_b_var;
  c20_b_w = c20_w;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 6U, 6U, c20_b_debug_family_names,
    c20_b_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargin, 0U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_nargout, 1U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_var, 2U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_w, 3U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_c_w, 4U, c20_b_sf_marshallOut,
    c20_b_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c20_b_varNew, 5U, c20_c_sf_marshallOut,
    c20_c_sf_marshallIn);
  CV_SCRIPT_FCN(2, 0);
  _SFD_SCRIPT_CALL(2U, chartInstance->c20_sfEvent, 5);
  for (c20_i3 = 0; c20_i3 < 9; c20_i3++) {
    c20_d_var[c20_i3] = c20_c_var.avgFilterBuf[c20_i3];
  }

  for (c20_i4 = 0; c20_i4 < 9; c20_i4++) {
    c20_c_var.avgFilterBuf[c20_i4 + 1] = c20_d_var[c20_i4];
  }

  _SFD_SCRIPT_CALL(2U, chartInstance->c20_sfEvent, 6);
  c20_c_var.avgFilterBuf[0] = c20_b_w;
  _SFD_SCRIPT_CALL(2U, chartInstance->c20_sfEvent, 7);
  for (c20_i5 = 0; c20_i5 < 10; c20_i5++) {
    c20_e_var[c20_i5] = c20_c_var.avgFilterBuf[c20_i5];
  }

  c20_A = c20_sum(chartInstance, c20_e_var);
  c20_d_x = c20_A;
  c20_e_x = c20_d_x;
  c20_f_x = c20_e_x;
  c20_c_w = c20_f_x / 10.0;
  _SFD_SCRIPT_CALL(2U, chartInstance->c20_sfEvent, 8);
  c20_b_varNew = c20_c_var;
  _SFD_SCRIPT_CALL(2U, chartInstance->c20_sfEvent, -8);
  _SFD_SYMBOL_SCOPE_POP();
  c20_w = c20_c_w;
  *c20_varNew = c20_b_varNew;
  _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 20);
  guard1 = false;
  if (CV_SCRIPT_COND(1, 0, CV_RELATIONAL_EVAL(14U, 1U, 2, c20_w, c20_param->wMin,
        -1, 2U, c20_w < c20_param->wMin))) {
    guard1 = true;
  } else if (CV_SCRIPT_COND(1, 1, CV_RELATIONAL_EVAL(14U, 1U, 3, c20_w,
               c20_param->wMax, -1, 4U, c20_w > c20_param->wMax))) {
    guard1 = true;
  } else {
    CV_SCRIPT_MCDC(1, 0, false);
    CV_SCRIPT_IF(1, 2, false);
    _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 22);
    if (CV_SCRIPT_IF(1, 3, CV_RELATIONAL_EVAL(14U, 1U, 4, c20_pW,
          (c20_param->pRated + c20_b_dP) - c20_b_dPlim, -1, 5U, c20_pW >=
          (c20_param->pRated + c20_b_dP) - c20_b_dPlim))) {
      _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 23);
      c20_c_varargin_2 = (c20_param->pRated + c20_b_dP) - c20_b_dPlim;
      c20_b_varargin_3 = c20_c_varargin_2;
      c20_d_y = c20_b_varargin_3;
      c20_e_y = c20_d_y;
      c20_eml_scalar_eg(chartInstance);
      c20_b_yk = c20_e_y;
      c20_f_y = c20_b_yk;
      c20_eml_scalar_eg(chartInstance);
      *c20_b_p = muDoubleScalarMax(0.0, c20_f_y);
    } else {
      _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 25);
      c20_b_varargin_1 = c20_b_dP;
      c20_d_varargin_2 = c20_b_varargin_1;
      c20_g_x = c20_d_varargin_2;
      c20_h_x = c20_g_x;
      c20_eml_scalar_eg(chartInstance);
      c20_b_xk = c20_h_x;
      c20_i_x = c20_b_xk;
      c20_eml_scalar_eg(chartInstance);
      c20_b_dP = muDoubleScalarMin(c20_i_x, 0.0);
      _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 26);
      c20_e_varargin_2 = c20_pW + c20_b_dP;
      c20_c_varargin_3 = c20_e_varargin_2;
      c20_g_y = c20_c_varargin_3;
      c20_h_y = c20_g_y;
      c20_eml_scalar_eg(chartInstance);
      c20_c_yk = c20_h_y;
      c20_i_y = c20_c_yk;
      c20_eml_scalar_eg(chartInstance);
      *c20_b_p = muDoubleScalarMax(0.0, c20_i_y);
    }
  }
  ...
  if (guard1 == true) {
    ...
    _SFD_SCRIPT_CALL(1U, chartInstance->c20_sfEvent, 21);
    *c20_b_p = 0.0;
  }
  ...
  *c20_inData)
{
  ...
  c20_sH1Kify8ZxEOY46vFTteWED c20_u;
  const mxArray *c20_y = NULL;
  real_T c20_b_u;
  const mxArray *c20_b_y = NULL;
  real_T c20_c_u;
  ...
  const mxArray *c20_j_y = NULL;
  SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
  c20_mxArrayOutData = NULL;
  c20_mxArrayOutData = NULL;
  c20_u = *(c20_sH1Kify8ZxEOY46vFTteWED *)c20_inData;
  c20_y = NULL;
  if (!chartInstance->c20_var_not_empty) {
    ...
    sf_mex_assign(&c20_b_y, sf_mex_create("y", &c20_b_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_b_y, "p_c", "p_c", 0);
    c20_c_u = c20_u.q_c;
    c20_c_y = NULL;
    sf_mex_assign(&c20_c_y, sf_mex_create("y", &c20_c_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_c_y, "q_c", "q_c", 0);
    c20_d_u = c20_u.pAva_c;
    c20_d_y = NULL;
    sf_mex_assign(&c20_d_y, sf_mex_create("y", &c20_d_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_d_y, "pAva_c", "pAva_c", 0);
    c20_e_u = c20_u.t_c;
    c20_e_y = NULL;
    sf_mex_assign(&c20_e_y, sf_mex_create("y", &c20_e_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_e_y, "t_c", "t_c", 0);
    c20_f_u = c20_u.pOld;
    c20_f_y = NULL;
    sf_mex_assign(&c20_f_y, sf_mex_create("y", &c20_f_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_f_y, "pOld", "pOld", 0);
    c20_g_u = c20_u.avgFilterTime;
    c20_g_y = NULL;
    sf_mex_assign(&c20_g_y, sf_mex_create("y", &c20_g_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_g_y, "avgFilterTime", "avgFilterTime", 0);
    for (c20_i6 = 0; c20_i6 < 10; c20_i6++) {
      c20_h_u[c20_i6] = c20_u.avgFilterBuf[c20_i6];
    }

    c20_h_y = NULL;
    sf_mex_assign(&c20_h_y, sf_mex_create("y", c20_h_u, 0, 0U, 1U, 0U, 1, 10),
                  false);
    sf_mex_addfield(c20_y, c20_h_y, "avgFilterBuf", "avgFilterBuf", 0);
    c20_i_u = c20_u.Qmode;
    c20_i_y = NULL;
    sf_mex_assign(&c20_i_y, sf_mex_create("y", &c20_i_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_i_y, "Qmode", "Qmode", 0);
    c20_j_u = c20_u.kWT;
    c20_j_y = NULL;
    sf_mex_assign(&c20_j_y, sf_mex_create("y", &c20_j_u, 0, 0U, 0U, 0U, 0),
                  false);
    sf_mex_addfield(c20_y, c20_j_y, "kWT", "kWT", 0);
  }
  ...
  c20_sH1Kify8ZxEOY46vFTteWED *c20_y)
{
  ...
  c20_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_b_var), &c20_thisId,
    c20_y);
  sf_mex_destroy(&c20_b_var);
}
...
{
  emlrtMsgIdentifier c20_thisId;
  static const char * c20_fieldNames[9] = { "p_c", "q_c", "pAva_c", "t_c",
  ...
  if (mxIsEmpty(c20_u)) {
    ...
    chartInstance->c20_var_not_empty = true;
    sf_mex_check_struct(c20_parentId, c20_u, 9, c20_fieldNames, 0U, NULL);
    c20_thisId.fIdentifier = "p_c";
    c20_y->p_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "p_c", "p_c", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "q_c";
    c20_y->q_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "q_c", "q_c", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "pAva_c";
    c20_y->pAva_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "pAva_c", "pAva_c", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "t_c";
    c20_y->t_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "t_c", "t_c", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "pOld";
    c20_y->pOld = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "pOld", "pOld", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "avgFilterTime";
    c20_y->avgFilterTime = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "avgFilterTime", "avgFilterTime", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "avgFilterBuf";
    c20_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield(c20_u,
      "avgFilterBuf", "avgFilterBuf", 0)), &c20_thisId, c20_y->avgFilterBuf);
    c20_thisId.fIdentifier = "Qmode";
    c20_y->Qmode = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "Qmode", "Qmode", 0)), &c20_thisId);
    c20_thisId.fIdentifier = "kWT";
    c20_y->kWT = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
      (sf_mex_getfield(c20_u, "kWT", "kWT", 0)), &c20_thisId);
  }
  ...
  real_T c20_y[10])
{
  ...
  int32_T c20_i7;
  (void)chartInstance;
  sf_mex_import(c20_parentId, sf_mex_dup(c20_u), c20_dv0, 1, 0, 0U, 1, 0U, 1, 10);
  for (c20_i7 = 0; c20_i7 < 10; c20_i7++) {
    c20_y[c20_i7] = c20_dv0[c20_i7];
  }
...
static void c20_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData)
{
  const mxArray *c20_b_var;
  const char_T *c20_identifier;
  emlrtMsgIdentifier c20_thisId;
  c20_sH1Kify8ZxEOY46vFTteWED c20_y;
  SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
  c20_b_var = sf_mex_dup(c20_mxArrayInData);
  ...
  c20_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_b_var), &c20_thisId,
    &c20_y);
  sf_mex_destroy(&c20_b_var);
  *(c20_sH1Kify8ZxEOY46vFTteWED *)c20_outData = c20_y;
  ...
  *chartInstance, const mxArray *c20_b_pAva, const char_T *c20_identifier)
{
  ...
  c20_thisId.fIdentifier = c20_identifier;
  c20_thisId.fParent = NULL;
  c20_y = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_b_pAva),
    &c20_thisId);
  sf_mex_destroy(&c20_b_pAva);
  return c20_y;
}
...
static void c20_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData)
{
  const mxArray *c20_b_pAva;
  const char_T *c20_identifier;
  emlrtMsgIdentifier c20_thisId;
  real_T c20_y;
  SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
  c20_b_pAva = sf_mex_dup(c20_mxArrayInData);
  c20_identifier = c20_varName;
  c20_thisId.fIdentifier = c20_identifier;
  c20_thisId.fParent = NULL;
  c20_y = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_b_pAva),
  ...
  *c20_inData)
{
  ...
  c20_f_u = c20_u.pOld;
  c20_f_y = NULL;
  sf_mex_assign(&c20_f_y, sf_mex_create("y", &c20_f_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_f_y, "pOld", "pOld", 0);
  c20_g_u = c20_u.avgFilterTime;
  c20_g_y = NULL;
  sf_mex_assign(&c20_g_y, sf_mex_create("y", &c20_g_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_g_y, "avgFilterTime", "avgFilterTime", 0);
  for (c20_i8 = 0; c20_i8 < 10; c20_i8++) {
    c20_h_u[c20_i8] = c20_u.avgFilterBuf[c20_i8];
  }
  ...
  c20_sH1Kify8ZxEOY46vFTteWED *c20_y)
{
  ...
  sf_mex_check_struct(c20_parentId, c20_u, 9, c20_fieldNames, 0U, NULL);
  c20_thisId.fIdentifier = "p_c";
  c20_y->p_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c20_u, "p_c", "p_c", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "q_c";
  c20_y->q_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c20_u, "q_c", "q_c", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "pAva_c";
  c20_y->pAva_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "pAva_c", "pAva_c", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "t_c";
  c20_y->t_c = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c20_u, "t_c", "t_c", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "pOld";
  c20_y->pOld = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
                                        (c20_u, "pOld", "pOld", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "avgFilterTime";
  c20_y->avgFilterTime = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "avgFilterTime", "avgFilterTime", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "avgFilterBuf";
  ...
  c20_y->Qmode = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "Qmode", "Qmode", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "kWT";
  c20_y->kWT = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c20_u, "kWT", "kWT", 0)), &c20_thisId);
  sf_mex_destroy(&c20_u);
}
...
static void c20_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData)
{
  const mxArray *c20_varNew;
  const char_T *c20_identifier;
  emlrtMsgIdentifier c20_thisId;
  c20_sH1Kify8ZxEOY46vFTteWED c20_y;
  SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
  c20_varNew = sf_mex_dup(c20_mxArrayInData);
  c20_identifier = c20_varName;
  c20_thisId.fIdentifier = c20_identifier;
  c20_thisId.fParent = NULL;
  c20_f_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_varNew), &c20_thisId,
    &c20_y);
  sf_mex_destroy(&c20_varNew);
  *(c20_sH1Kify8ZxEOY46vFTteWED *)c20_outData = c20_y;
  sf_mex_destroy(&c20_mxArrayInData);
}
...
{
  const mxArray *c20_mxArrayOutData = NULL;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_u;
  const mxArray *c20_y = NULL;
  real_T c20_b_u;
  const mxArray *c20_b_y = NULL;
  real_T c20_c_u;
  ...
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
  c20_mxArrayOutData = NULL;
  c20_u = *(c20_sXgiQ0K2zU5uHJ7gdbD52xC *)c20_inData;
  c20_y = NULL;
  sf_mex_assign(&c20_y, sf_mex_createstruct("structure", 2, 1, 1), false);
  c20_b_u = c20_u.vBase;
  c20_b_y = NULL;
  sf_mex_assign(&c20_b_y, sf_mex_create("y", &c20_b_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_b_y, "vBase", "vBase", 0);
  c20_c_u = c20_u.pRated;
  c20_c_y = NULL;
  sf_mex_assign(&c20_c_y, sf_mex_create("y", &c20_c_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_c_y, "pRated", "pRated", 0);
  c20_d_u = c20_u.sMax;
  c20_d_y = NULL;
  sf_mex_assign(&c20_d_y, sf_mex_create("y", &c20_d_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_d_y, "sMax", "sMax", 0);
  c20_e_u = c20_u.wMin;
  c20_e_y = NULL;
  sf_mex_assign(&c20_e_y, sf_mex_create("y", &c20_e_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_e_y, "wMin", "wMin", 0);
  c20_f_u = c20_u.wMax;
  c20_f_y = NULL;
  sf_mex_assign(&c20_f_y, sf_mex_create("y", &c20_f_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_f_y, "wMax", "wMax", 0);
  c20_g_u = c20_u.wRated;
  c20_g_y = NULL;
  sf_mex_assign(&c20_g_y, sf_mex_create("y", &c20_g_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_g_y, "wRated", "wRated", 0);
  c20_h_u = c20_u.rfTau;
  c20_h_y = NULL;
  sf_mex_assign(&c20_h_y, sf_mex_create("y", &c20_h_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_h_y, "rfTau", "rfTau", 0);
  c20_i_u = c20_u.PF;
  c20_i_y = NULL;
  sf_mex_assign(&c20_i_y, sf_mex_create("y", &c20_i_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_i_y, "PF", "PF", 0);
  c20_j_u = c20_u.Ts;
  c20_j_y = NULL;
  sf_mex_assign(&c20_j_y, sf_mex_create("y", &c20_j_u, 0, 0U, 0U, 0U, 0), false);
  sf_mex_addfield(c20_y, c20_j_y, "Ts", "Ts", 0);
  sf_mex_assign(&c20_mxArrayOutData, c20_y, false);
  return c20_mxArrayOutData;
}
...
{
  emlrtMsgIdentifier c20_thisId;
  static const char * c20_fieldNames[9] = { "vBase", "pRated", "sMax", "wMin",
    "wMax", "wRated", "rfTau", "PF", "Ts" };

  c20_thisId.fParent = c20_parentId;
  sf_mex_check_struct(c20_parentId, c20_u, 9, c20_fieldNames, 0U, NULL);
  c20_thisId.fIdentifier = "vBase";
  c20_y->vBase = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "vBase", "vBase", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "pRated";
  c20_y->pRated = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "pRated", "pRated", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "sMax";
  c20_y->sMax = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
                                        (c20_u, "sMax", "sMax", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "wMin";
  c20_y->wMin = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
                                        (c20_u, "wMin", "wMin", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "wMax";
  c20_y->wMax = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
                                        (c20_u, "wMax", "wMax", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "wRated";
  c20_y->wRated = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "wRated", "wRated", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "rfTau";
  c20_y->rfTau = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getfield(c20_u, "rfTau", "rfTau", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "PF";
  c20_y->PF = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c20_u, "PF", "PF", 0)), &c20_thisId);
  c20_thisId.fIdentifier = "Ts";
  c20_y->Ts = c20_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getfield
    (c20_u, "Ts", "Ts", 0)), &c20_thisId);
  sf_mex_destroy(&c20_u);
}
...
static void c20_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData)
{
  const mxArray *c20_param;
  const char_T *c20_identifier;
  emlrtMsgIdentifier c20_thisId;
  c20_sXgiQ0K2zU5uHJ7gdbD52xC c20_y;
  SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
  c20_param = sf_mex_dup(c20_mxArrayInData);
  c20_identifier = c20_varName;
  c20_thisId.fIdentifier = c20_identifier;
  c20_thisId.fParent = NULL;
  c20_g_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_param), &c20_thisId,
    &c20_y);
  sf_mex_destroy(&c20_param);
  *(c20_sXgiQ0K2zU5uHJ7gdbD52xC *)c20_outData = c20_y;
  sf_mex_destroy(&c20_mxArrayInData);
}
  ...
  *c20_inData)
{
  ...
  c20_mxArrayOutData = NULL;
  c20_y = NULL;
  sf_mex_assign(&c20_y, sf_mex_create("y", NULL, 10, 0U, 1U, 0U, 2, 1, 0), false);
  sf_mex_assign(&c20_mxArrayOutData, c20_y, false);
  return c20_mxArrayOutData;
}

const mxArray *sf_c20_DiSC_ToolboxOpal_V11_get_eml_resolved_functions_info(void)
{
  const mxArray *c20_nameCaptureInfo = NULL;
  c20_nameCaptureInfo = NULL;
  sf_mex_assign(&c20_nameCaptureInfo, sf_mex_createstruct("structure", 2, 83, 1),
                false);
...
static void c20_info_helper(const mxArray **c20_info)
{
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "resolved",
                  "resolved", 0);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1410807648U), "fileTimeLo",
                  "fileTimeLo", 0);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 0);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1370009886U), "mFileTimeLo",
                  "mFileTimeLo", 0);
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/assert.m"),
                  "resolved", "resolved", 1);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1389717774U), "fileTimeLo",
                  "fileTimeLo", 1);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 1);
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mrdivide.p"), "context",
                  "context", 2);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("rdivide"), "name", "name", 2);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 2);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "resolved",
                  "resolved", 2);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1363713880U), "fileTimeLo",
                  "fileTimeLo", 2);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 2);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/rdivide.m"), "context",
                  "context", 5);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("eml_div"), "name", "name", 5);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 5);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_div.m"), "resolved",
                  "resolved", 5);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1386423952U), "fileTimeLo",
                  "fileTimeLo", 5);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 5);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs6), "lhs", "lhs",
                  6);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(""), "context", "context", 7);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("ceil"), "name", "name", 7);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 7);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/ceil.m"), "resolved",
                  "resolved", 7);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1363713852U), "fileTimeLo",
                  "fileTimeLo", 7);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 7);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/ceil.m"), "context",
                  "context", 9);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("eml_scalar_ceil"), "name",
                  "name", 9);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 9);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_ceil.m"),
                  "resolved", "resolved", 9);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1286818720U), "fileTimeLo",
                  "fileTimeLo", 9);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 9);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs9), "lhs", "lhs",
                  9);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(""), "context", "context", 10);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("mpower"), "name", "name", 10);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 10);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/ismatrix.m"), "resolved",
                  "resolved", 12);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1331304858U), "fileTimeLo",
                  "fileTimeLo", 12);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 12);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "context",
                  "context", 13);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("power"), "name", "name", 13);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 13);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m"), "resolved",
                  "resolved", 13);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1395328506U), "fileTimeLo",
                  "fileTimeLo", 13);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 13);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/power.m!fltpower"), "context",
                  "context", 19);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("floor"), "name", "name", 19);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 19);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
                  "resolved", 19);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1363713854U), "fileTimeLo",
                  "fileTimeLo", 19);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 19);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1286818726U), "fileTimeLo",
                  "fileTimeLo", 21);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 21);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs22), "lhs", "lhs",
                  22);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(""), "context", "context", 23);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("sampleWT"), "name", "name",
                  23);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 23);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1431812332U), "fileTimeLo",
                  "fileTimeLo", 23);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 23);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/sampleWT.m"),
                  "context", "context", 24);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("pCtrlWT"), "name", "name",
                  24);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 24);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1432045132U), "fileTimeLo",
                  "fileTimeLo", 24);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 24);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/pCtrlWT.m"),
                  "context", "context", 25);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("mpower"), "name", "name", 25);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 25);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/pCtrlWT.m"),
                  "context", "context", 26);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("min"), "name", "name", 26);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 26);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "resolved",
                  "resolved", 26);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1311255318U), "fileTimeLo",
                  "fileTimeLo", 26);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 26);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/min.m"), "context",
                  "context", 27);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("eml_min_or_max"), "name",
                  "name", 27);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 27);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1378295984U), "fileTimeLo",
                  "fileTimeLo", 27);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 27);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/pCtrlWT.m"),
                  "context", "context", 33);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("avgFilterWT"), "name",
                  "name", 33);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 33);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1432045202U), "fileTimeLo",
                  "fileTimeLo", 33);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 33);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/avgFilterWT.m"),
                  "context", "context", 34);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("sum"), "name", "name", 34);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 34);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m"), "resolved",
                  "resolved", 34);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1395930306U), "fileTimeLo",
                  "fileTimeLo", 34);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 34);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m"), "context",
                  "context", 36);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("sumprod"), "name", "name",
                  36);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 36);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1395930302U), "fileTimeLo",
                  "fileTimeLo", 36);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 36);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXPE]$matlabroot$/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                  "context", "context", 39);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("process_sumprod_inputs"),
                  "name", "name", 39);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 39);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXPE]$matlabroot$/toolbox/eml/lib/matlab/datafun/private/process_sumprod_inputs.m"),
                  "context", "context", 40);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("coder.internal.narginchk"),
                  "name", "name", 40);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(""), "dominantType",
                  "dominantType", 40);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1363714558U), "fileTimeLo",
                  "fileTimeLo", 40);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 40);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/shared/coder/coder/+coder/+internal/narginchk.m"),
                  "context", "context", 41);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("floor"), "name", "name", 41);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 41);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/floor.m"), "resolved",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1372583160U), "fileTimeLo",
                  "fileTimeLo", 43);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 43);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXPE]$matlabroot$/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                  "context", "context", 46);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("isequal"), "name", "name",
                  46);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 46);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m"), "resolved",
                  "resolved", 46);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1286818758U), "fileTimeLo",
                  "fileTimeLo", 46);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 46);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1286818786U), "fileTimeLo",
                  "fileTimeLo", 47);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 47);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXPE]$matlabroot$/toolbox/eml/lib/matlab/datafun/private/sumprod.m"),
                  "context", "context", 48);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("combine_vector_elements"),
                  "name", "name", 48);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("function_handle"),
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1397257422U), "fileTimeLo",
                  "fileTimeLo", 49);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 49);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 50);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("isfi"), "name", "name", 50);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("coder.internal.indexInt"),
                  "dominantType", "dominantType", 50);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "resolved",
                  "resolved", 50);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1346510358U), "fileTimeLo",
                  "fileTimeLo", 50);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 50);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isfi.m"), "context",
                  "context", 51);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("isnumerictype"), "name",
                  "name", 51);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 51);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/fixedpoint/isnumerictype.m"), "resolved",
                  "resolved", 51);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1398875598U), "fileTimeLo",
                  "fileTimeLo", 51);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 51);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m!eml_int_forloop_overflow_check_helper"),
                  "context", "context", 52);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("intmax"), "name", "name", 52);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 52);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/intmax.m"), "resolved",
                  "resolved", 52);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1362261882U), "fileTimeLo",
                  "fileTimeLo", 52);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 52);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/avgFilterWT.m"),
                  "context", "context", 56);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("length"), "name", "name", 56);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 56);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/length.m"), "resolved",
                  "resolved", 56);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1303146206U), "fileTimeLo",
                  "fileTimeLo", 56);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 56);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/pCtrlWT.m"),
                  "context", "context", 58);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("max"), "name", "name", 58);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 58);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/datafun/max.m"), "resolved",
                  "resolved", 58);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1311255316U), "fileTimeLo",
                  "fileTimeLo", 58);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 58);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/sampleWT.m"),
                  "context", "context", 60);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("qCtrlWT"), "name", "name",
                  60);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 60);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1432045112U), "fileTimeLo",
                  "fileTimeLo", 60);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 60);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 61);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("acos"), "name", "name", 61);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 61);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "resolved",
                  "resolved", 61);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1395328492U), "fileTimeLo",
                  "fileTimeLo", 61);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 61);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m"), "resolved",
                  "resolved", 62);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1343830358U), "fileTimeLo",
                  "fileTimeLo", 62);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 62);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/acos.m"), "context",
                  "context", 63);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("eml_scalar_acos"), "name",
                  "name", 63);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 63);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1343830376U), "fileTimeLo",
                  "fileTimeLo", 63);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 63);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
...
static void c20_b_info_helper(const mxArray **c20_info)
{
  ...
  const mxArray *c20_rhs75 = NULL;
  const mxArray *c20_lhs75 = NULL;
  const mxArray *c20_rhs76 = NULL;
  const mxArray *c20_lhs76 = NULL;
  const mxArray *c20_rhs77 = NULL;
  const mxArray *c20_lhs77 = NULL;
  const mxArray *c20_rhs78 = NULL;
  const mxArray *c20_lhs78 = NULL;
  const mxArray *c20_rhs79 = NULL;
  const mxArray *c20_lhs79 = NULL;
  const mxArray *c20_rhs80 = NULL;
  const mxArray *c20_lhs80 = NULL;
  const mxArray *c20_rhs81 = NULL;
  const mxArray *c20_lhs81 = NULL;
  const mxArray *c20_rhs82 = NULL;
  const mxArray *c20_lhs82 = NULL;
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[E]//ES.AAU.DK/Users/seifu/Documents/Project_Triumphant_Career/Astonishing_Remote_Grid/SC2net_Benchmark_Grid_Simulink_Model/DiSC"
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 64);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("tan"), "name", "name", 64);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 64);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/tan.m"), "context",
                  "context", 65);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("eml_scalar_tan"), "name",
                  "name", 65);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 65);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1286818738U), "fileTimeLo",
                  "fileTimeLo", 65);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 65);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 66);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("droopWT"), "name", "name",
                  66);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 66);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1432045172U), "fileTimeLo",
                  "fileTimeLo", 66);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 66);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/droopWT.m"),
                  "context", "context", 68);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("defaultDroopWT"), "name",
                  "name", 68);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 68);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1432045182U), "fileTimeLo",
                  "fileTimeLo", 68);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 68);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 70);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("error"), "name", "name", 70);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("char"), "dominantType",
                  "dominantType", 70);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/lang/error.m"), "resolved",
                  "resolved", 70);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1319729966U), "fileTimeLo",
                  "fileTimeLo", 70);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 70);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 71);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("mpower"), "name", "name", 71);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 71);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/mpower.m"), "resolved",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 72);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("sqrt"), "name", "name", 72);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 72);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m"), "resolved",
                  "resolved", 72);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1343830386U), "fileTimeLo",
                  "fileTimeLo", 72);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 72);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    ...
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 75);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("abs"), "name", "name", 75);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 75);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 75);
  sf_mex_assign(&c20_rhs75, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs75, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs75), "rhs", "rhs",
                  75);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs75), "lhs", "lhs",
                  75);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 76);
  sf_mex_assign(&c20_rhs76, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs76, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs76), "rhs", "rhs",
                  76);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs76), "lhs", "lhs",
                  76);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/abs.m"), "context",
                  "context", 77);
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1286818712U), "fileTimeLo",
                  "fileTimeLo", 77);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 77);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 77);
  sf_mex_assign(&c20_rhs77, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs77, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs77), "rhs", "rhs",
                  77);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs77), "lhs", "lhs",
                  77);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[E]//ES.AAU.DK/Users/seifu/Documents/Project_Triumphant_Career/Astonishing_Remote_Grid/SC2net_Benchmark_Grid_Simulink_Model/DiSC"
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/qCtrlWT.m"),
                  "context", "context", 78);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("sign"), "name", "name", 78);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 78);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m"), "resolved",
                  "resolved", 78);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1363713856U), "fileTimeLo",
                  "fileTimeLo", 78);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 78);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 78);
  sf_mex_assign(&c20_rhs78, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs78, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs78), "rhs", "rhs",
                  78);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs78), "lhs", "lhs",
                  78);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 79);
  sf_mex_assign(&c20_rhs79, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs79, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs79), "rhs", "rhs",
                  79);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs79), "lhs", "lhs",
                  79);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sign.m"), "context",
                  "context", 80);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("eml_scalar_sign"), "name",
                  "name", 80);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("double"), "dominantType",
                  "dominantType", 80);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1356541494U), "fileTimeLo",
                  "fileTimeLo", 80);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 80);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 80);
  sf_mex_assign(&c20_rhs80, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs80, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs80), "rhs", "rhs",
                  80);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs80), "lhs", "lhs",
                  80);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[E]//ES.AAU.DK/Users/seifu/Documents/Project_Triumphant_Career/Astonishing_Remote_Grid/SC2net_Benchmark_Grid_Simulink_Model/DiSC"
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/sampleWT.m"),
                  "context", "context", 81);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("rotorFilterWT"), "name",
                  "name", 81);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut("struct"), "dominantType",
                  "dominantType", 81);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(1432045104U), "fileTimeLo",
                  "fileTimeLo", 81);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "fileTimeHi",
                  "fileTimeHi", 81);
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeLo",
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 81);
  sf_mex_assign(&c20_rhs81, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs81, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs81), "rhs", "rhs",
                  81);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs81), "lhs", "lhs",
                  81);
  sf_mex_addfield(*c20_info, c20_emlrt_marshallOut(
    "[E]//ES.AAU.DK/Users/seifu/Documents/Project_Triumphant_Career/Astonishing_Remote_Grid/SC2net_Benchmark_Grid_Simulink_Model/DiSC"
    "_Opal_Toolbox/Prelim_Models/DiSC_Opal_Toolbox/models/WindPowerPlantDO/rotorFilterWT.m"),
  ...
  sf_mex_addfield(*c20_info, c20_b_emlrt_marshallOut(0U), "mFileTimeHi",
                  "mFileTimeHi", 82);
  sf_mex_assign(&c20_rhs82, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_assign(&c20_lhs82, sf_mex_createcellmatrix(0, 1), false);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_rhs82), "rhs", "rhs",
                  82);
  sf_mex_addfield(*c20_info, sf_mex_duplicatearraysafe(&c20_lhs82), "lhs", "lhs",
                  82);
  ...
  sf_mex_destroy(&c20_rhs75);
  sf_mex_destroy(&c20_lhs75);
  sf_mex_destroy(&c20_rhs76);
  sf_mex_destroy(&c20_lhs76);
  sf_mex_destroy(&c20_rhs77);
  sf_mex_destroy(&c20_lhs77);
  sf_mex_destroy(&c20_rhs78);
  sf_mex_destroy(&c20_lhs78);
  sf_mex_destroy(&c20_rhs79);
  sf_mex_destroy(&c20_lhs79);
  sf_mex_destroy(&c20_rhs80);
  sf_mex_destroy(&c20_lhs80);
  sf_mex_destroy(&c20_rhs81);
  sf_mex_destroy(&c20_lhs81);
  sf_mex_destroy(&c20_rhs82);
  sf_mex_destroy(&c20_lhs82);
}
  ...
  real_T c20_a)
{
  ...
  c20_eml_scalar_eg(chartInstance);
  c20_ar = c20_d_a;
  return muDoubleScalarPower(c20_ar, 3.0);
}
                      ...
                      real_T c20_x[10])
{
  ...
  (void)chartInstance;
  c20_y = c20_x[0];
  for (c20_k = 2; c20_k < 11; c20_k++) {
    c20_b_k = c20_k;
    c20_y += c20_x[_SFD_EML_ARRAY_BOUNDS_CHECK("", (int32_T)_SFD_INTEGER_CHECK(
      "", (real_T)c20_b_k), 1, 10, 1, 0) - 1];
  }
  ...
  *chartInstance)
{
  ...
  const mxArray *c20_y = NULL;
  int32_T c20_i10;
  static char_T c20_cv1[4] = { 'a', 'c', 'o', 's' };

  char_T c20_b_u[4];
  const mxArray *c20_b_y = NULL;
  (void)chartInstance;
  for (c20_i9 = 0; c20_i9 < 30; c20_i9++) {
    c20_u[c20_i9] = c20_cv0[c20_i9];
  }
  ...
  for (c20_i10 = 0; c20_i10 < 4; c20_i10++) {
    c20_b_u[c20_i10] = c20_cv1[c20_i10];
  }
...
{
  int32_T c20_i11;
  static char_T c20_cv2[30] = { 'C', 'o', 'd', 'e', 'r', ':', 't', 'o', 'o', 'l',
    'b', 'o', 'x', ':', 'E', 'l', 'F', 'u', 'n', 'D', 'o', 'm', 'a', 'i', 'n',
    'E', 'r', 'r', 'o', 'r' };
  ...
  const mxArray *c20_y = NULL;
  int32_T c20_i12;
  static char_T c20_cv3[4] = { 's', 'q', 'r', 't' };

  char_T c20_b_u[4];
  const mxArray *c20_b_y = NULL;
  (void)chartInstance;
  for (c20_i11 = 0; c20_i11 < 30; c20_i11++) {
    c20_u[c20_i11] = c20_cv2[c20_i11];
  }

  c20_y = NULL;
  sf_mex_assign(&c20_y, sf_mex_create("y", c20_u, 10, 0U, 1U, 0U, 2, 1, 30),
                false);
  for (c20_i12 = 0; c20_i12 < 4; c20_i12++) {
    c20_b_u[c20_i12] = c20_cv3[c20_i12];
  }
  ...
  *chartInstance, const mxArray *c20_u, const emlrtMsgIdentifier *c20_parentId)
{
  ...
  int32_T c20_i13;
  (void)chartInstance;
  sf_mex_import(c20_parentId, sf_mex_dup(c20_u), &c20_i13, 1, 6, 0U, 0, 0U, 0);
  c20_y = c20_i13;
  sf_mex_destroy(&c20_u);
  return c20_y;
}
  ...
  *c20_mxArrayInData, const char_T *c20_varName, void *c20_outData)
{
  ...
  c20_thisId.fIdentifier = c20_identifier;
  c20_thisId.fParent = NULL;
  c20_y = c20_h_emlrt_marshallIn(chartInstance, sf_mex_dup(c20_b_sfEvent),
    &c20_thisId);
  ...
  char_T *c20_identifier)
{
  ...
  c20_thisId.fIdentifier = c20_identifier;
  c20_thisId.fParent = NULL;
  c20_y = c20_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c20_b_is_active_c20_DiSC_ToolboxOpal_V11), &c20_thisId);
  sf_mex_destroy(&c20_b_is_active_c20_DiSC_ToolboxOpal_V11);
  return c20_y;
}
...
static void init_simulink_io_address(SFc20_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance)
{
  chartInstance->c20_p = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c20_wind = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 0);
  chartInstance->c20_vMeas = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c20_dP = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c20_dPlim = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c20_qRef = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c20_qMode = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 5);
  chartInstance->c20_vRef = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 6);
  chartInstance->c20_time = (real_T *)ssGetInputPortSignal_wrapper
    (chartInstance->S, 7);
  chartInstance->c20_q = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c20_pAva = (real_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
}
...
void sf_c20_DiSC_ToolboxOpal_V11_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c20_DiSC_ToolboxOpal_V11_get_post_codegen_info(void);
mxArray *sf_c20_DiSC_ToolboxOpal_V11_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c20_DiSC_ToolboxOpal_V11_get_post_codegen_info();
...
mxArray *sf_c20_DiSC_ToolboxOpal_V11_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c20_DiSC_ToolboxOpal_V11_jit_fallback_info(void)
{
...
mxArray *sf_c20_DiSC_ToolboxOpal_V11_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c20_DiSC_ToolboxOpal_V11(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"p\",},{M[1],M[15],T\"pAva\",},{M[1],M[14],T\"q\",},{M[4],M[0],T\"var\",S'l','i','p'{{M1x2[1661 1664],M[0],}}},{M[8],M[0],T\"is_active_c20_DiSC_ToolboxOpal_V11\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c20_DiSC_ToolboxOpal_V11_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_COMPILED_PROPS(10,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c20_b_sf_marshallOut,(MexInFcnForType)
          c20_b_sf_marshallIn);
        _SFD_SET_DATA_VALUE_PTR(0U, chartInstance->c20_p);
        _SFD_SET_DATA_VALUE_PTR(1U, chartInstance->c20_wind);
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance->c20_vMeas);
        _SFD_SET_DATA_VALUE_PTR(3U, chartInstance->c20_dP);
        _SFD_SET_DATA_VALUE_PTR(4U, chartInstance->c20_dPlim);
        _SFD_SET_DATA_VALUE_PTR(5U, chartInstance->c20_qRef);
        _SFD_SET_DATA_VALUE_PTR(6U, chartInstance->c20_qMode);
        _SFD_SET_DATA_VALUE_PTR(7U, chartInstance->c20_vRef);
        _SFD_SET_DATA_VALUE_PTR(8U, chartInstance->c20_time);
        _SFD_SET_DATA_VALUE_PTR(9U, chartInstance->c20_q);
        _SFD_SET_DATA_VALUE_PTR(10U, chartInstance->c20_pAva);
      }
    } else {
...
static void sf_opaque_initialize_c20_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c20_DiSC_ToolboxOpal_V11
    ((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*) chartInstanceVar);
  initialize_c20_DiSC_ToolboxOpal_V11((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c20_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  enable_c20_DiSC_ToolboxOpal_V11((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c20_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  disable_c20_DiSC_ToolboxOpal_V11((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c20_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  sf_gateway_c20_DiSC_ToolboxOpal_V11((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c20_DiSC_ToolboxOpal_V11(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c20_DiSC_ToolboxOpal_V11
    ((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c20_DiSC_ToolboxOpal_V11(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c20_DiSC_ToolboxOpal_V11
    ((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c20_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c20_DiSC_ToolboxOpal_V11((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc20_DiSC_ToolboxOpal_V11
    ((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c20_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c20_DiSC_ToolboxOpal_V11
      ((SFc20_DiSC_ToolboxOpal_V11InstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c20_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c20_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c20_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  SFc20_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc20_DiSC_ToolboxOpal_V11InstanceStruct *)utMalloc(sizeof
    (SFc20_DiSC_ToolboxOpal_V11InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc20_DiSC_ToolboxOpal_V11InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.mdlStart = mdlStart_c20_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c20_DiSC_ToolboxOpal_V11;
...
void c20_DiSC_ToolboxOpal_V11_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c20_DiSC_ToolboxOpal_V11(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c20_DiSC_ToolboxOpal_V11(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c20_DiSC_ToolboxOpal_V11(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c20_DiSC_ToolboxOpal_V11_method_dispatcher.\n"
