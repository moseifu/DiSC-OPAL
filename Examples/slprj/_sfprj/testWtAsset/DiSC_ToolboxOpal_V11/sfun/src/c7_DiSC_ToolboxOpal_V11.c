...
static void initialize_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void initialize_params_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void enable_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void disable_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void c7_update_debugger_state_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void set_sim_state_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance, const mxArray *c7_st);
static void finalize_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void sf_gateway_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void mdl_start_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void c7_chartstep_c7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void initSimStructsc7_DiSC_ToolboxOpal_V11
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static void c7_sampleWT(SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
...
static void c7_pCtrlWT(SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
...
static void c7_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_b_var, const char_T *c7_identifier,
  c7_sH1Kify8ZxEOY46vFTteWED *c7_y);
static void c7_b_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  c7_sH1Kify8ZxEOY46vFTteWED *c7_y);
static real_T c7_c_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_d_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[10]);
...
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static real_T c7_e_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_b_pAva, const char_T *c7_identifier);
static void c7_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_f_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  c7_sH1Kify8ZxEOY46vFTteWED *c7_y);
...
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_g_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
...
static real_T c7_mpower(SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
  real_T c7_a);
static void c7_eml_scalar_eg(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static real_T c7_sum(SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
                     real_T c7_x[10]);
static void c7_eml_error(SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance);
static real_T c7_b_mpower(SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance,
  real_T c7_a);
static void c7_b_eml_error(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static const mxArray *c7_f_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_h_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_i_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_DiSC_ToolboxOpal_V11, const
  char_T *c7_identifier);
static uint8_T c7_j_emlrt_marshallIn(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void init_dsm_address_info(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc7_DiSC_ToolboxOpal_V11InstanceStruct
  *chartInstance);
  ...
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_DiSC_ToolboxOpal_V11 = 0U;
}
  ...
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  c7_d_hoistedGlobal = chartInstance->c7_is_active_c7_DiSC_ToolboxOpal_V11;
  ...
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance, const mxArray *c7_st)
{
  ...
  *chartInstance->c7_q = c7_e_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c7_is_active_c7_DiSC_ToolboxOpal_V11 = c7_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 4)),
     "is_active_c7_DiSC_ToolboxOpal_V11");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_DiSC_ToolboxOpal_V11(chartInstance);
  ...
  (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_DiSC_ToolboxOpal_V11(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_j_y = NULL;
  SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  chartInstance = (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_DiSC_ToolboxOpal_V11_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c7_identifier)
{
  ...
  c7_y = c7_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_DiSC_ToolboxOpal_V11), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_DiSC_ToolboxOpal_V11);
  return c7_y;
}
...
void sf_c7_DiSC_ToolboxOpal_V11_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c7_DiSC_ToolboxOpal_V11_get_post_codegen_info(void);
mxArray *sf_c7_DiSC_ToolboxOpal_V11_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c7_DiSC_ToolboxOpal_V11_get_post_codegen_info();
...
mxArray *sf_c7_DiSC_ToolboxOpal_V11_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c7_DiSC_ToolboxOpal_V11_jit_fallback_info(void)
{
...
mxArray *sf_c7_DiSC_ToolboxOpal_V11_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_DiSC_ToolboxOpal_V11(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x5'type','srcId','name','auxInfo'{{M[1],M[5],T\"p\",},{M[1],M[15],T\"pAva\",},{M[1],M[14],T\"q\",},{M[4],M[0],T\"var\",S'l','i','p'{{M1x2[1661 1664],M[0],}}},{M[8],M[0],T\"is_active_c7_DiSC_ToolboxOpal_V11\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 5, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_DiSC_ToolboxOpal_V11_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *)
...
static void sf_opaque_initialize_c7_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_DiSC_ToolboxOpal_V11
    ((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*) chartInstanceVar);
  initialize_c7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  enable_c7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  disable_c7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  sf_gateway_c7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c7_DiSC_ToolboxOpal_V11(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c7_DiSC_ToolboxOpal_V11
    ((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c7_DiSC_ToolboxOpal_V11(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c7_DiSC_ToolboxOpal_V11(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*) chartInstanceVar
      )->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_DiSC_ToolboxOpal_V11((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c7_DiSC_ToolboxOpal_V11
      ((SFc7_DiSC_ToolboxOpal_V11InstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c7_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_DiSC_ToolboxOpal_V11(SimStruct *S)
{
  SFc7_DiSC_ToolboxOpal_V11InstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc7_DiSC_ToolboxOpal_V11InstanceStruct *)utMalloc(sizeof
    (SFc7_DiSC_ToolboxOpal_V11InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_DiSC_ToolboxOpal_V11InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_DiSC_ToolboxOpal_V11;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_DiSC_ToolboxOpal_V11;
...
void c7_DiSC_ToolboxOpal_V11_method_dispatcher(SimStruct *S, int_T method, void *
  data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_DiSC_ToolboxOpal_V11(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_DiSC_ToolboxOpal_V11(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_DiSC_ToolboxOpal_V11(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_DiSC_ToolboxOpal_V11_method_dispatcher.\n"
